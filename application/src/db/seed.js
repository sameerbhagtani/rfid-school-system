...
// data
import usersData from "../data/user.data.json" with { type: "json" };
import attendancesData from "../data/attendance.data.json" with { type: "json" };
import holidaysData from "../data/holiday.data.json" with { type: "json" };
